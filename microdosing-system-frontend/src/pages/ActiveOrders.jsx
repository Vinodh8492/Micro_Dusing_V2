...
const ActiveOrders = () => {
        ...
        const enrichedMaterials = await Promise.all(
          recipeMaterials.map(async (mat, idx) => {
            try {
              ...
              console.error(`Error fetching names for recipe_id ${mat.recipe_id} or material_id ${mat.material_id}`, innerErr);
              return null;
            }
          })
        );
  ...
  useEffect(() => {
    ...
    console.log("Verifying barcode for:", currentMaterial.title || currentMaterial.materialName);
  ...
  const confirmDosing = async () => {
    ...
    try {
      ...
      console.error('Error saving dosing record:', error);
